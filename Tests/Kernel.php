...
/**
 * Class Kernel
 * @package Bytes\TwitchClientBundle\Tests\Command
 */
class Kernel extends BaseKernel
{
     ...
     *
     * All configured values are randomly generated using the same character sets and lengths as actual Twitch values
     */
...
//            $container->register(MockTooManyRequestsCallback::class);
            ...
            $container->loadFromExtension('bytes_twitch-client', $this->config);
        });
    }

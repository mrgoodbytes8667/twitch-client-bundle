...
use Bytes\TwitchClientBundle\Tests\Fixtures\Commands\Sample;
...
use Bytes\TwitchClientBundle\Tests\MockHttpClient\MockJsonTooManyRetriesResponse;
...
{
    use TestTwitchFakerTrait, GuildProviderTrait;

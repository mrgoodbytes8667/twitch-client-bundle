 ...
 */
class GetReactionsTest extends TestTwitchBotClientCase
{
    ...
    public function testGetReactions()
    {
        /** @var User[] $guilds */
        $users = $this
            ->setupResponse('HttpClient/get-reactions-success.json', type: '\Bytes\TwitchResponseBundle\Objects\User[]')
            ->deserialize();

 ...
 */
class GetChannelMessagesTest extends TestTwitchBotClientCase
{
    ...
    public function testGetChannelMessages()
    {
        ...
        $messages = $this
            ->setupResponse('HttpClient/get-channel-messages-success.json', type: '\Bytes\TwitchResponseBundle\Objects\Message[]')
            ->deserialize();

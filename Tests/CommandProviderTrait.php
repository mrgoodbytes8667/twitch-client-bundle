...
use Bytes\TwitchClientBundle\Tests\HttpClient\TwitchBotClient\GuildProviderTrait;
...
use Bytes\TwitchResponseBundle\Objects\Slash\ApplicationCommandOptionChoice;
use DateTime;
use Generator;
